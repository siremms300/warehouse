...
import { PlusCircleIcon, SearchIcon, Trash2Icon } from "lucide-react"; // Import Trash2Icon
...
const Products = () => {
  ...
  const {
    ...
    isLoading,
    isError,
    refetch, // Add refetch to refresh the list after deletion
  ...
  const handleDeleteProduct = async (productId: string) => {
    try {
      await deleteProduct(productId).unwrap(); // Call the delete mutation
          ...
          products?.map((product) => (
            ...
            >
              ...
              <div className="flex flex-col items-center">
                <Image
                  src={`https://s3-warehousemanagement.s3.us-east-1.amazonaws.com/product${
